...
| --- | --- | --- | --- | --- |
| `mapop_79438d8e0bbed945` | `/lastError;4;0;pub.event:exceptionInfo` | `/lastError;4;0;pub.event:exceptionInfo` |  | `PGP/ns/pgp/test/keys/testReadPrivateKeys/flow.xml:226` |
...
| Operation | Source | Target | Literal | Evidence |
| --- | --- | --- | --- | --- |
| `mapop_dbe123a8e445e2f2` |  | `/userId;1;0` | `<redacted:literal>` | `PGP/ns/pgp/test/keys/testReadPrivateKeys/flow.xml:105` |
...
| --- | --- | --- | --- | --- | --- |
| `call_b9dbb1340957e8e6` | True | `FLOW` | `FULL` | `pgp.services.registry:getSecKey` | `PGP/ns/pgp/test/keys/testReadPrivateKeys/flow.xml:39` |
| `call_b1b16109953ba663` | False | `UNKNOWN` | `UNKNOWN` | `pub.flow:getLastError` | `PGP/ns/pgp/test/keys/testReadPrivateKeys/flow.xml:141` |
...
-   `fn0002` SEQUENCE
-     `fn0003` SEQUENCE
-       `fn0004` INVOKE (target=pgp.services.registry:getSecKey)
-         `fn0005` MAP
-     `fn0006` SEQUENCE
...
- INVOKE `call_b9dbb1340957e8e6` target `pgp.services.registry:getSecKey`:
  `PGP/ns/pgp/test/keys/testReadPrivateKeys/flow.xml`:39- INVOKE `call_b1b16109953ba663` target `pub.flow:getLastError`:
  `PGP/ns/pgp/test/keys/testReadPrivateKeys/flow.xml`:141
