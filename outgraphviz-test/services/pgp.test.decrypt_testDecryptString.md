...
| --- | --- | --- | --- | --- |
| `mapop_279c01c50e4de399` | `/lastError;4;0;pub.event:exceptionInfo` | `/lastError;4;0;pub.event:exceptionInfo` |  | `PGP/ns/pgp/test/decrypt/testDecryptString/flow.xml:368` |
...
| Operation | Source | Target | Literal | Evidence |
| --- | --- | --- | --- | --- |
| `mapop_7fd0a155f254707d` |  | `/encryptedString;1;0` | `<redacted:literal>` | `PGP/ns/pgp/test/decrypt/testDecryptString/flow.xml:124` |
| `mapop_134a349812721545` |  | `/userId;1;0` | `<redacted:literal>` | `PGP/ns/pgp/test/decrypt/testDecryptString/flow.xml:165` |
...
| ---: | --- | --- | --- | --- |
| 1 | True | `FLOW` | `FULL` | `pgp.services.decrypt:decryptString` |
...
| --- | --- | --- | --- | --- | --- |
| `call_720a12678fc16b87` | True | `FLOW` | `FULL` | `pgp.services.decrypt:decryptString` | `PGP/ns/pgp/test/decrypt/testDecryptString/flow.xml:39` |
| `call_a5ca57b7d82200a2` | False | `UNKNOWN` | `UNKNOWN` | `pub.flow:getLastError` | `PGP/ns/pgp/test/decrypt/testDecryptString/flow.xml:283` |
...
-   `fn0002` SEQUENCE
-     `fn0003` SEQUENCE
-       `fn0004` INVOKE (target=pgp.services.decrypt:decryptString)
-         `fn0005` MAP
-         `fn0006` MAP
-     `fn0007` SEQUENCE
-       `fn0008` INVOKE (target=pub.flow:getLastError)
-         `fn0009` MAP
-         `fn0010` MAP
...
- INVOKE `call_720a12678fc16b87` target `pgp.services.decrypt:decryptString`:
  `PGP/ns/pgp/test/decrypt/testDecryptString/flow.xml`:39- INVOKE `call_a5ca57b7d82200a2` target `pub.flow:getLastError`:
  `PGP/ns/pgp/test/decrypt/testDecryptString/flow.xml`:283
