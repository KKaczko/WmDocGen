# pgp.services.keys:listKeyExchangeAlgorithms
...
| Service | `listKeyExchangeAlgorithms` |
| Type | `JAVA` |
...
This service lists all supported algorithms for key exchanges.
...
| Fragment | `PGP/ns/pgp/services/keys/listKeyExchangeAlgorithms/java.frag` |
| Class | `keys` |
| Method | `listKeyExchangeAlgorithms` |
| Token match | `True` |
| Method range | `82:2-97:3` |
...
| --- | --- | --- | --- | --- | --- |
| `javapipe_2a55d92582c96407` | `IDataUtil.put` | `algorithms` | `ROOT_PIPELINE` | `` | `PGP/code/source/pgp/services/keys.java:90` |
...
| --- | --- | --- | --- |
| `IDataCursor` | `com.wm.data.IDataCursor` | `WEBMETHODS_API` | `PGP/code/source/pgp/services/keys.java:89` |
| `IDataUtil` | `com.wm.data.IDataUtil` | `WEBMETHODS_API` | `PGP/code/source/pgp/services/keys.java:90` |
| `PGPInit` | `com.softwareag.pgp.PGPInit` | `PACKAGE_LOCAL_CLASS` | `PGP/code/source/pgp/services/keys.java:91` |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | True | `FULL` | `pgp.test.keys:testListAlgorithms` | `INVOKES` | `PGP/ns/pgp/test/keys/testListAlgorithms/flow.xml:39` |
...
- Service metadata: `PGP/ns/pgp/services/keys/listKeyExchangeAlgorithms/node.ndf`
- Signature metadata: `PGP/ns/pgp/services/keys/listKeyExchangeAlgorithms/node.ndf`
