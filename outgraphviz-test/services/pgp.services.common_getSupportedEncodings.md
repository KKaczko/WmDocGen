# pgp.services.common:getSupportedEncodings
...
This service tests a character set encoding for being supported and returns all supported encodings.
...
| Fragment | `PGP/ns/pgp/services/common/getSupportedEncodings/java.frag` |
| Class | `common` |
| Method | `getSupportedEncodings` |
| Token match | `True` |
| Method range | `150:2-174:3` |
...
| --- | --- | --- | --- | --- | --- |
| `javapipe_d52a74b2957395cc` | `IDataUtil.getString` | `encoding` | `ROOT_PIPELINE` | `String` | `PGP/code/source/pgp/services/common.java:158` |
...
| Access | API | Key | Scope | Type | Evidence |
| --- | --- | --- | --- | --- | --- |
| `javapipe_157d571d136afe9e` | `IDataUtil.put` | `isSupported` | `ROOT_PIPELINE` | `` | `PGP/code/source/pgp/services/common.java:162` |
| `javapipe_92c47aa27d0da6ec` | `IDataUtil.put` | `encodings` | `ROOT_PIPELINE` | `` | `PGP/code/source/pgp/services/common.java:166` |
| `javapipe_61626503b603695b` | `IDataUtil.put` | `default` | `ROOT_PIPELINE` | `` | `PGP/code/source/pgp/services/common.java:168` |
...
| --- | --- | --- | --- |
| `Charset` | `java.nio.charset.Charset` | `JAVA_STANDARD_LIBRARY` | `PGP/code/source/pgp/services/common.java:162` |
| `IDataCursor` | `com.wm.data.IDataCursor` | `WEBMETHODS_API` | `PGP/code/source/pgp/services/common.java:157` |
| `IDataUtil` | `com.wm.data.IDataUtil` | `WEBMETHODS_API` | `PGP/code/source/pgp/services/common.java:158` |
...
- Service metadata: `PGP/ns/pgp/services/common/getSupportedEncodings/node.ndf`
- Signature metadata: `PGP/ns/pgp/services/common/getSupportedEncodings/node.ndf`
