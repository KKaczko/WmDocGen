# pgp.services.keys:listSignatureAlgorithms
...
| Service | `listSignatureAlgorithms` |
| Type | `JAVA` |
...
This service lists all supported algorithms for digital signing.
...
| Fragment | `PGP/ns/pgp/services/keys/listSignatureAlgorithms/java.frag` |
| Class | `keys` |
| Method | `listSignatureAlgorithms` |
| Token match | `True` |
| Method range | `103:2-118:3` |
...
| --- | --- | --- | --- | --- | --- |
| `javapipe_110985a22096240d` | `IDataUtil.put` | `algorithms` | `ROOT_PIPELINE` | `` | `PGP/code/source/pgp/services/keys.java:111` |
...
| --- | --- | --- | --- |
| `IDataCursor` | `com.wm.data.IDataCursor` | `WEBMETHODS_API` | `PGP/code/source/pgp/services/keys.java:110` |
| `IDataUtil` | `com.wm.data.IDataUtil` | `WEBMETHODS_API` | `PGP/code/source/pgp/services/keys.java:111` |
| `PGPInit` | `com.softwareag.pgp.PGPInit` | `PACKAGE_LOCAL_CLASS` | `PGP/code/source/pgp/services/keys.java:112` |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | True | `FULL` | `pgp.test.keys:testListAlgorithms` | `INVOKES` | `PGP/ns/pgp/test/keys/testListAlgorithms/flow.xml:299` |
...
- Service metadata: `PGP/ns/pgp/services/keys/listSignatureAlgorithms/node.ndf`
- Signature metadata: `PGP/ns/pgp/services/keys/listSignatureAlgorithms/node.ndf`
